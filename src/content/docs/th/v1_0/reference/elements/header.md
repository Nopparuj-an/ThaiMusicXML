...
1. [`<title>`](/th/v1_0/reference/elements/title/) - หนึ่งเดียว
2. [`<composer>`](/th/v1_0/reference/elements/composer/) - ศูนย์หรือมากกว่า หนึ่งต่อผู้ประพันธ์
3. [`<lyricist>`](/th/v1_0/reference/elements/lyricist/) - ศูนย์หรือมากกว่า หนึ่งต่อผู้แต่งคำร้อง
4. [`<arranger>`](/th/v1_0/reference/elements/arranger/) - ศูนย์หรือมากกว่า หนึ่งต่อผู้เรียบเรียง
5. [`<tuning>`](/th/v1_0/reference/elements/tuning/) - ศูนย์หรือหนึ่ง
6. [`<license>`](/th/v1_0/reference/elements/license/) - ศูนย์หรือหนึ่ง
