...
[โครงสร้างไฟล์](/th/v0_1/tutorial/2-file_structure/) แสดงท่อนเดียวที่ซ้ำ หน้านี้เพิ่มหลายท่อน การซ้อนซ้ำ การซ้ำบรรทัด และจุดจบแบบที่สอง ทั้งหมดปรากฏในเพลงลาวดวงเดือน

![ลาวดวงเดือน, ท่อน 1 และ 2](../../../../../assets/docs/v0_1/tutorial/6-sections_repeats_endings/image.png)
...
ขั้นต่อไป ดู [เครื่องดนตรีหลายตัวและโน้ตซ้อน](/th/v0_1/tutorial/7-ensembles_stacked/) สำหรับโน้ตที่มีหลายพาร์ตและเครื่องดนตรีที่เขียนข้ามหลายแถว

:::note[องค์ประกอบที่แนะนำ]
[`<section>`](/th/v0_1/reference/elements/section/), [`<repeat>`](/th/v0_1/reference/elements/repeat/), [`<line-repeat>`](/th/v0_1/reference/elements/line-repeat/), [`<ending>`](/th/v0_1/reference/elements/ending/)
:::
