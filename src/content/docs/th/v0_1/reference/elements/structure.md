...
- [`<br>`](/th/v0_1/reference/elements/br/)
- [`<direction>`](/th/v0_1/reference/elements/direction/)
- [`<section>`](/th/v0_1/reference/elements/section/)
...
ลำดับท่อนของโน้ตคือลำดับที่องค์ประกอบ `<section>` ปรากฏ นับเฉพาะ `<section>` และเดินแบบ depth first เข้าตัวครอบ [`<repeat>`](/th/v0_1/reference/elements/repeat/) องค์ประกอบ `<annotation>`, `<br>`, และ `<direction>` ที่แทรกไม่กระทบ ไม่มีแอตทริบิวต์ระบุลำดับ การจัดลำดับองค์ประกอบ `<section>` ใหม่ในเอกสารจึงจัดลำดับโน้ตใหม่

## ทิศทาง

[`<direction>`](/th/v0_1/reference/elements/direction/) มีผล ณ จุดที่ปรากฏและคงอยู่จน `<direction>` อื่นเปลี่ยนการตั้งค่าเดียวกัน ตัวประมวลผลอ่าน `<structure>` จากบนลงล่าง ทิศทางใช้กับทุกพาร์ต
