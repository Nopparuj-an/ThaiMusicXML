...
- [`<nathap>`](/th/v0_1/reference/elements/nathap/) - หน้าทับ (รอบจังหวะกลอง)
- [`<chan>`](/th/v0_1/reference/elements/chan/) - ชั้น (ระดับชั้นจังหวะ)
- [`<bpm>`](/th/v0_1/reference/elements/bpm/) - จังหวะ
