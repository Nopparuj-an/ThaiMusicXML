...
- [`<annotation>`](/en/v0_1/reference/elements/annotation/) - zero or more, before the lines
- [`<line>`](/en/v0_1/reference/elements/line/) - one or more
- [`<ending>`](/en/v0_1/reference/elements/ending/) - zero or more, per-pass variations for a repeated section
