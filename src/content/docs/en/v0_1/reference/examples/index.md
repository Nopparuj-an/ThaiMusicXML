...
- `<part>`'s `hand` and `pair` attributes linking ฆ้องวงใหญ่ R and L as one two-handed instrument
...
- [`<group>`](/en/v0_1/reference/elements/group/) subdividing a beat into three, with `link` joining a group to the paired hand's beat
