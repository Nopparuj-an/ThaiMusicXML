...
A group says how a beat divides. It does not say that the notes belong together as one movement of the hands. For that, write a [`<link>`](/en/v0_1/reference/elements/link/) span around them:
...
[`<group>`](/en/v0_1/reference/elements/group/), [`<link>`](/en/v0_1/reference/elements/link/)
:::
