...
ThaiMusicXML is an open, royalty-free digital notation standard for Thai traditional music (เพลงไทยเดิม/Phleng Thai Doem).

Western music theory uses 5-line staves, clefs, 12-TET divisions, sharps and flats, and variable time signatures. These do not map directly to Thai music, so this format models Thai musical concepts: 7-tone scales, 8-measure grid systems. Thai traditional notation uses a different structure:
