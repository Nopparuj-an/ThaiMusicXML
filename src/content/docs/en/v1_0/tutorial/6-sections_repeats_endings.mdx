...
[File Structure](/en/v1_0/tutorial/2-file_structure/) showed a single section repeated. This page adds several sections, nested repeats, line-repeats, and a second ending. All of these appear in ลาวดวงเดือน.

![ลาวดวงเดือน, ท่อน 1 and 2](../../../../../assets/docs/v1_0/tutorial/6-sections_repeats_endings/image.png)
...
Next, see [Ensembles and stacked instruments](/en/v1_0/tutorial/7-ensembles_stacked/) for scores with several parts and instruments notated across multiple rows.

:::note[Elements introduced]
[`<section>`](/en/v1_0/reference/elements/section/), [`<repeat>`](/en/v1_0/reference/elements/repeat/), [`<line-repeat>`](/en/v1_0/reference/elements/line-repeat/), [`<ending>`](/en/v1_0/reference/elements/ending/)
:::
