...
![ลาวดวงเดือน, ระนาดเอก and เนื้อร้อง](../../../../../assets/docs/v1_0/tutorial/8-lyrics/image.png)
...
Next, see [Marking the score](/en/v1_0/tutorial/9-marking_the_score/) for bow spans, cued passages, annotations, and metadata.

:::note[Elements introduced]
[`type="lyric"`](/en/v1_0/reference/elements/part/#part-types), [`<syllable>`](/en/v1_0/reference/elements/syllable/)
:::
