...
[Ensembles and stacked instruments](/en/v1_0/tutorial/7-ensembles_stacked/) added several parts to the score. This page covers the elements that turn a bare grid into a printed sheet: bow spans, cued passages, annotations, and metadata.
...
Next, see [Validating and going further](/en/v1_0/tutorial/10-validating/) for schema validation, the Playground, and where to go from here.

:::note[Elements introduced]
[`<bow>`](/en/v1_0/reference/elements/bow/), [`<parenthesis>`](/en/v1_0/reference/elements/parenthesis/), [`<br>`](/en/v1_0/reference/elements/br/), [`<text align>`](/en/v1_0/reference/elements/text/), [`<lyricist>`](/en/v1_0/reference/elements/lyricist/), [`<arranger>`](/en/v1_0/reference/elements/arranger/), [`<tuning>`](/en/v1_0/reference/elements/tuning/), [`<license>`](/en/v1_0/reference/elements/license/), [`<nathap>`](/en/v1_0/reference/elements/nathap/)
:::
