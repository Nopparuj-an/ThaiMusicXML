...
1. [`<title>`](/en/v1_0/reference/elements/title/) - exactly one
2. [`<composer>`](/en/v1_0/reference/elements/composer/) - zero or more, one per composer
3. [`<lyricist>`](/en/v1_0/reference/elements/lyricist/) - zero or more, one per lyricist
4. [`<arranger>`](/en/v1_0/reference/elements/arranger/) - zero or more, one per arranger
5. [`<tuning>`](/en/v1_0/reference/elements/tuning/) - zero or one
6. [`<license>`](/en/v1_0/reference/elements/license/) - zero or one
