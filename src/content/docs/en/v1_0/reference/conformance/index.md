...
- A lyric part's `<ending>` matches on measure count alone, the same exemption it has everywhere else. See [Varying the words](/en/v1_0/reference/elements/ending/#varying-the-words).
